document.addEventListener('DOMContentLoaded', function() {
    ...
    function getBotResponse(userMessage) {
        ...
        if (userMessage.includes('book') || userMessage.includes('appointment')) {
            ...
            return "Our services start at Rs.150 and go up to Rs.500 for premium packages. The exact price depends on the service and your specific needs. Would you like details about a particular service?";
